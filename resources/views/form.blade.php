        ...
        <div class="card" style="width: 18rem;box-shadow: 10px 10px;">
            <div class="card-body">
                ...
                <div class="container mt-5">
                    <small class="align-center" style="color: wheat;">Copyright by <a href="https://github.com/bgZams" style="text-decoration: none;color: wheat;"> @bgZams</a></small>
                </div>
            </div>
        </div>
    </div>
